  ...
  return (
    <div className='flex relative min-h-[calc(-58px+100vh)]'>
      ...
      >
        {!isReadOnlyUser ? (
          <Drawer.Body
            className='overflow-hidden! w-[294px]!'
            htmlAttributes={{ style: { backgroundColor: '#000000' } }}
          >
            ...
            <div className='flex flex-col h-full'>
              <div className='relative h-full'>
                {process.env.VITE_ENV !== 'PROD' && (
                  <div
                    className='mx-6 flex! items-center justify-between pb-6 border-b'
                    style={{ borderColor: 'rgba(202, 248, 0, 0.2)' }}
                  >
                ...
                {!connectionStatus && (
                  ...
                  >
                    <Typography variant='body-medium' className='flex items-center gap-1'>
                      ...
                      <span>Connect to Graph instance to upload documents</span>
                    </Typography>
                  </div>
                )}
                  ...
                  <div className={`resource-sections ${!connectionStatus ? 'blur-sm pointer-events-none' : ''}`}>
                    <Flex gap='6' className='h-full source-container'>
                      {APP_SOURCES.includes('local') && (
                        <div
                          className='px-6 outline-dashed outline-2 outline-offset-2 mt-3 imageBg'
                          style={{ outlineColor: 'rgba(202, 248, 0, 0.4)' }}
                        >
                          <DropZone />
                        </div>
                      )}
                      {APP_SOURCES.some((source) => ['youtube', 'wiki', 'web'].includes(source)) && (
                        <div
                          className='outline-dashed imageBg w-[245px]'
                          style={{ outlineColor: 'rgba(202, 248, 0, 0.4)' }}
                        >
          ...
          >
            <Typography
              ...
              style={{
                ...
                backgroundColor: 'rgba(202, 248, 0, 0.05)',
              }}
              htmlAttributes={{
                onClick: () => {
                  loginWithRedirect();
            ...
            >
              ...
              <span className='text-center mx-1' style={{ color: '#caf800' }}>
                {filesData.length === 0
